...
export function BundleTest() {
    ...
    <section className='bundle_section'>
                <div className='bundle-featured' style={{backgroundImage:"url('/images/Livingroom.png')"}}>
                    <div className='text'>
                        <p>Living Room</p>
                        <a href="/shop"  style={{backgroundImage:"url('/images/Livingroom.png')"}}>Shop Now <span className='material-symbols-outlined'>arrow_right_alt</span></a>
                    </div>
                </div>
                <div className='double-bundle'>
                    ...
                    <div className='text'>
                        <p>Bedroom</p>
                        <a href="/shop" >Shop Now <span className='material-symbols-outlined'>arrow_right_alt</span></a>
                    </div>
                </div>
